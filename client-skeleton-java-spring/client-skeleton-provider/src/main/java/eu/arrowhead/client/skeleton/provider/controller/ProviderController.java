...
public class ProviderController {
	...
	@PostMapping(path="/{setpoint}")
	@ResponseBody
	public String PlugSwitching(@PathVariable(name= "setpoint") String switchPlugState) {
	
		PlugSwitcher.switchPlug (Double.parseDouble(switchPlugState));
		
		return "ThermoPlug switch to new setpoint "+switchPlugState;
