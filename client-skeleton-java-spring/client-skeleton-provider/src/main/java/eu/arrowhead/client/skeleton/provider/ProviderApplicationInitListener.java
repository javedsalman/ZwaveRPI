...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO createCarServiceRequest = createServiceRegistryRequest(PlugProviderConstants.SWITCH_PLUG_SERVICE_DEFINITION, PlugProviderConstants.PLUG_URI, HttpMethod.POST);
		arrowheadService.forceRegisterServiceToServiceRegistry(createCarServiceRequest);
		logger.info("Registered "+PlugProviderConstants.SWITCH_PLUG_SERVICE_DEFINITION+" service");
		
		PlugSwitcher.switchPlug (Double.parseDouble("26.35"));
	...
	public void customDestroy() {
		...
		arrowheadService.unregisterServiceFromServiceRegistry(PlugProviderConstants.SWITCH_PLUG_SERVICE_DEFINITION);
	}
