...
class PlugSwitcher {
    ...
    public static void switchPlug(double switchWishedState){
        try{
            ...
            ProcessBuilder pb = new ProcessBuilder("py ","C:\\Users\\javsal\\Documents\\GitHub\\client-skeleton-java-spring\\client-skeleton-provider\\src\\main\\java\\eu\\arrowhead\\client\\skeleton\\provider\\set_thermostat_setpoint.py",""+switchWishedState1);
